...
#
# RCS Revision Code:
#   $Id: is_numeric_float.py,v 1.1 2004/04/28 00:28:15 jlin Exp $
#
...
def is_numeric_float(*arrays):
    ...
    for array in arrays:
        ...
        if array.typename() == N.Float:    is_float = 1
        if array.typename() == N.Float0:   is_float = 1
        if array.typename() == N.Float8:   is_float = 1
        if array.typename() == N.Float16:  is_float = 1
        if array.typename() == N.Float32:  is_float = 1
        if array.typename() == N.Float64:  is_float = 1
